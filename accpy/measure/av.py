...
features = ['AcquisitionAbort',
            ...
            'EventPtpSyncLocked',
            'EventPtpSyncLockedFrameID',
            'EventPtpSyncLockedTimestamp',
            'EventPtpSyncLost',
            'EventPtpSyncLostFrameID',
            'EventPtpSyncLostTimestamp',
            'EventSelector',
            'EventsEnable1',
            'ExposureAuto',
            ...
            'GevDeviceMACAddress',
            'GevHeartbeatInterval',
            'GevHeartbeatTimeout',
            'GevIPConfigurationMode',
